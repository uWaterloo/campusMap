...
var CampusMap = function () {
    ...
    CampusMap.prototype._configure = function _configure(mapElement) {
        ...
        // Setup buildings
        var layer_config = this._config.map.buildings;
        ...
        this._buildings = new _building2.default(layer_config, callback);
        ...
        layers.forEach(function (layer_config, i) {
            ...
            if (!(layer_config.id in _this2._layers)) {
                switch (layer_config.type) {
                    case 'parent':
                        layer = new _parent2.default(layer_config.id, layer_config.name);
                        _this2._configureLayers(layer_config.sublayers, layer);

                        break;
                    case 'html':
                        layer = new _html2.default(layer_config.id, layer_config.name, layer_config.html);
                        break;
...
},{"./layer/building":4,"./layer/data":5,"./layer/html":6,"./layer/parent":8,"./layer/parking":9,"_process":20,"buffer":13,"es6-promise":14,"leaflet":18,"minivents":19,"urijs":23,"whatwg-fetch":25}],2:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
},{"./layers":10,"_process":20,"buffer":13}],3:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
},{"_process":20,"buffer":13,"leaflet":18}],4:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
var BuildingLayer = function (_UnclusteredDataLayer) {
    ...
    function BuildingLayer(config, dataCallback) {
        ...
        if (!config.options.pointToLayer) {
            config.options.pointToLayer = function (feature, latlng) {
                ...
                marker.on('popupopen', function () {
                    ...
                    _this.emit('building-selected', feature.properties);
                });
                marker.on('popupclose', function () {
                    marker.setIcon(icon);
                    _this.emit('building-deselected', feature.properties);
                });
    ...
    BuildingLayer.prototype._filter = function _filter(event) {
        ...
        this._layers.forEach(function (layer) {
            ...
            if (_this2.map.getZoom() < 16) {
                _this2.removeLayer(layer);
            } else if (_this2.map.getZoom() < 17 && layer.feature.properties.building_parent !== null) {
                _this2.removeLayer(layer);
            } else {
        ...
        if (building && !(building in this._buildings)) {
            (function () {
                var func = function func(item) {
                    ...
                    setTimeout(function () {
                        return select.call(_this3, building, changeView);
                    }, 100);
                    this.off('data', func);
                };

                _this4.on('data', func.bind(_this4));
            })();
        } else {
    ...
    _createClass(BuildingLayer, [{
        ...
        get: function get() {
            ...
            Object.keys(this._buildings).forEach(function (building_code) {
                buildings[building_code] = _this5._buildings[building_code].props;
            });
...
},{"../directions":3,"./data":5,"_process":20,"buffer":13,"leaflet":18}],5:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
var UnclusteredDataLayer = exports.UnclusteredDataLayer = function (_NamedGeoJSONLayer) {
    ...
    function UnclusteredDataLayer(config, dataCallback) {
        ...
        var _this2 = _possibleConstructorReturn(this, _NamedGeoJSONLayer.call(this, config.id, config.name, [], options));
...
},{"../directions":3,"./named":7,"_process":20,"buffer":13,"leaflet":18,"leaflet.markercluster":17}],6:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
var HTMLLayer = function (_NamedLayer) {
    ...
    function HTMLLayer(id, name, html) {
...
},{"./named":7,"_process":20,"buffer":13}],7:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
var NamedGeoJSONLayer = exports.NamedGeoJSONLayer = function (_L$GeoJSON) {
    ...
    function NamedGeoJSONLayer(id, name, data, options) {
...
},{"_process":20,"buffer":13,"leaflet":18,"minivents":19}],8:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
},{"./named":7,"_process":20,"buffer":13}],9:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
},{"../directions":3,"./data":5,"_process":20,"buffer":13,"leaflet":18}],10:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
},{"./directions":3,"_process":20,"buffer":13,"leaflet":18}],11:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
_config2.default['imagePath'] = 'http://work.private.zacharyseguin.ca/map/dist';
...
app.controller('campusMapCtrl', ['$scope', function ($scope) {
	// Initialize
	$scope.search = { value: null };
	$scope.map = { value: null };
	$scope.buildings = { value: null };

	// Functions
	$scope.toggleLayer = function (layer) {
		if ($scope.map.value.map.hasLayer(layer)) {
			$scope.map.value.map.removeLayer(layer);
		} else {
			$scope.map.value.map.addLayer(layer);
		} // End of if/else
	}; // End of toggleLayer

	$scope.$watch('map.value', function (new_value, old_value) {
		if (!new_value) return;
	...
	function link(scope, element, attrs) {
		...
		scope.map.value = new _campusmap2.default(_config2.default, element[0]);
		...
		menu_button.onAdd = function (map) {
			...
			_leaflet2.default.DomEvent.on(a, 'click', function (e) {
				...
				$timeout(function () {
					return scope.map.value.map.invalidateSize();
				}, 1500);
		...
		menu_button.addTo(scope.map.value.map);

		setTimeout(function () {
			scope.map.value.map.invalidateSize();
		}, 500);
	}
...
},{"./campusmap":1,"./config":2,"_process":20,"buffer":13,"leaflet":18}],12:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict'
...
},{"_process":20,"buffer":13}],13:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
...
},{"_process":20,"base64-js":12,"buffer":13,"ieee754":15,"isarray":16}],14:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
...
},{"_process":20,"buffer":13}],15:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":20,"buffer":13}],16:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":20,"buffer":13}],17:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*
...
},{"_process":20,"buffer":13}],18:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*
...
},{"_process":20,"buffer":13}],19:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":20,"buffer":13}],20:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":20,"buffer":13}],21:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
...
},{"_process":20,"buffer":13}],22:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
 * URI.js - Mutating URLs
...
},{"_process":20,"buffer":13}],23:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
 * URI.js - Mutating URLs
 *
...
},{"./IPv6":21,"./SecondLevelDomains":22,"./punycode":24,"_process":20,"buffer":13}],24:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":20,"buffer":13}],25:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
(function(self) {
  'use strict';
